...
Shared dotfiles (kitty, rofi theme, mangohud, waybar style, hypr start script) live in `modules/home.nix`.
Anything that differs between machines (e.g. hyprland.conf, kvm-switch.sh) goes in the host's `home.nix`.
